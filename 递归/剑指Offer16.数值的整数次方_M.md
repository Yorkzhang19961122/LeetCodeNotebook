...
n的二进制形式一定是由若干0和1构成，例如$x^{9}$，快速幂的思想就是将指数9转换为二进制数：9=1001=$1*2^3+0*2^2+0*2^1+1*2^0$，则 $x^{9}=x^{1*2^3+0*2^2+0*2^1+1*2^0}=x^{1*2^0}*x^{0*2^1}*x^{0*2^2}*x^{1*2^3}$，看以看出，每次乘以的值都是前一个值的平方，当n对应位为0时跳过。
